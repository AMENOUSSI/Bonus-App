<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Identity Reference -->
        <div class="mt-4">
            <x-input-label for="identity_reference" :value="__('Numero Reference_ID')" />
        ...
        <!-- Registration Number -->
        <div class="mt-4">
            <x-input-label for="registration_number" :value="__('Matricule')" />
        ...
        <!-- Sponsor -->
        <div class="mt-4">
            <x-input-label for="sponsor_id" :value="__('Parain / Sponsor')" />
            <select id="sponsor_id" name="sponsor_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-input-label for="password" :value="__('Mot de Pass Confirmation')" />
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-input-label for="password_confirmation" :value="__('Mot de Pass Confirmation')" />
