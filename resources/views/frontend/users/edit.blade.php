                        ...
                        <form method="POST" action="{{ route('users.update',$user) }}">
                            ...
                            <div class="flex flex-wrap -mx-2">
                                ...
                                <div class="w-full md:w-1/2 px-2">
                                    <div class="mb-4">
                                        <label for="first_name" class="block mb-2 text-xl font-medium text-gray-900 dark:text-white">Nom</label>
                                    ...
                                    <div class="mb-4">
                                        <label for="identity_reference" class="block mb-2 text-xl font-medium text-gray-900 dark:text-white">Numero Identite Reference</label>
                                ...
                                <div class="w-full md:w-1/2 px-2">
                                    ...
                                    <div class="mb-4">
                                        <label for="registration_number" class="block mb-2 text-xl font-medium text-gray-900 dark:text-white">Matricule</label>
                                    ...
                                    <div class="mb-4">
                                        <label for="sponsor_id" class="block mb-2 text-xl font-medium text-gray-900 dark:text-white">Distributeur / Sponsor</label>
